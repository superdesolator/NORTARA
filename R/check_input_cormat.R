...
#'the function will return \code{TRUE}, otherwise it will print out the elements'
...
#'@return If all the elements of the input correlation matrix all in the bounds the function
#'will return \code{TRUE}, otherwise it will print messages about the out of bounds #'elements' positions and then give an error message to users.
#'
#'
#'@seealso \code{\link{BoundingRA}}, \code{\link{valid_input_cormat}},
#'  \code{\link{gennortaRA}}
#'@note Because of the random samples, the results of the function may be a little
#'different each time.
#'@examples
#'\dontrun{
